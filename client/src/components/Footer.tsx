      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-base">
              Engaging resources and articles for students, teachers, and history enthusiasts.
            </p>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link href="/resources?type=lesson-plan">
                      <a className="text-base text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400">
                        Lesson Plans
                      </a>
                    </Link>
                  ...
                  <li>
                    <Link href="/resources?type=presentation">
                      <a className="text-base text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400">
                        Presentations
                      </a>
                    </Link>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link href="/articles?category=ancient-history">
                      <a className="text-base text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400">
                        Ancient History
                      </a>
                    </Link>
                  ...
                  <li>
                    <Link href="/articles?category=world-cultures">
                      <a className="text-base text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400">
                        World Cultures
                      </a>
                    </Link>
                  ...
                  <li>
                    <Link href="/resources?type=interactive">
                      <a className="text-base text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400">
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8">
          <p className="text-base text-gray-500 dark:text-gray-400 text-center">
            &copy; {currentYear} Social Studies Corner. All rights reserved.
          </p>
          <p className="text-sm text-gray-400 dark:text-gray-500 text-center mt-2">
            Designed for educational use. Works offline with local storage.
          </p>
        </div>
      </div>
    </footer>
